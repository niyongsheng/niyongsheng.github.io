...
AC.Detector = {
    ...
    // ** {{{ AC.Detector.isCSSAvailable(required) }}} **
    //
    // Returns whether the CSS {{{property}}} is available.
    //
    // {{{property}}}: the CSS property to test
    //
    ...
    //
    // Returns whether the browser supports `transform-style: preserve-3d;`.
    //
